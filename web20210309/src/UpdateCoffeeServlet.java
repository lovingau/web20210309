...
public class UpdateCoffeeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 response.setContentType("text/html;charset=UTF-8");
	        ...
	        try {
	            ...
	            boolean flag=true;
	            try {
	               flag=updateCoffeeSales(coffee,sale,total);
	...
	public boolean updateCoffeeSales(String coffee,String sale,String total)
		    throws SQLException {
		    Connection con=null;
		    ...
		    try {
		         ...
		         con =  DriverManager.getConnection("jdbc:mysql://localhost:3306/coffeedb","root","1234");
